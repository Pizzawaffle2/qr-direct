...
import { QrCode, Layout, HardDrive, Users, Loader2 } from 'lucide-react';
            ...
            <Card key={metric.name} className="p-6">
              <div className="mb-4 flex items-center justify-between">
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  {metric.limit !== -1 && <> / {metric.format(metric.limit)}</>}
                </div>
              </div>
              {metric.limit !== -1 && (
                <Progress
              ...
              {percentage > 90 && (
                <p className="mt-2 text-sm text-red-500">Near limit - Consider upgrading</p>
              )}
            </Card>
          );
        })}
