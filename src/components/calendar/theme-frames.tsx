  ...
  return (
    <div className="relative">
      <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ opacity: 0.1 }}>
        <defs>
          {FRAME_PATTERNS[theme.frame.borderStyle as keyof typeof FRAME_PATTERNS]}
        </defs>
...
export function ApplyTheme({ theme, children }: { theme: CalendarTheme; children: React.ReactNode }) {
  return (
    <div
