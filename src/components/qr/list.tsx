...
import {Download, Edit, Trash2, BarChart2, Link } from 'lucide-react';
        ...
        <TableBody>
          {qrCodes.map((qr) => (
            <TableRow key={qr.id}>
              ...
              <TableCell>{format(new Date(qr.created), &apos;MMM d, yyyy')}</TableCell>
              ...
              <TableCell className="text-right">
                <div className="flex justify-end gap-2">
                  ...
                  <Button variant="outline" size="icon" onClick={() => handleDelete(qr.id)}>
